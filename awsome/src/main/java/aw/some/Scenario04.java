...
public class Scenario04 {
  ...
  public Scenario04(ListNode head) { this.head = head; }
  ...
  static class ListNode {
    ...
    public ListNode(int dataInTheNode) { this.dataInTheNode = dataInTheNode; }

    public int getDataInTheNode() { return this.dataInTheNode; }
